...
namespace AkiGames.Core
{
    public class GameObject(string name) : GameStructure
    {
        ...
        public T? GetComponent<T>() where T : GameComponent =>
            Components.OfType<T>().FirstOrDefault() ?? null;
        ...
        public event Action<GameObject> ChildAdded = null!;
        ...
        {
            // Предполагается, что Image и Text теперь работают с Veldrid.SpriteBatch
